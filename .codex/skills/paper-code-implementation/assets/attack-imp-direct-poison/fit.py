...
用法:
  python attacks/attack_imp_direct_poison/fit.py --config attacks/attack_imp_direct_poison/config.yaml
"""
...
from attacks.attack_imp_direct_poison.registry import (
    get_dataset_cls,
    get_model_cls,
    load_model_config,
)
